...
![Untitled](Testing%20en%20React%20con%20Vitest%200576e9ab3dd5414c9f5cd96863a5a2c9/Untitled.png)

![Untitled](Testing%20en%20React%20con%20Vitest%200576e9ab3dd5414c9f5cd96863a5a2c9/Untitled%201.png)

Pero si vemos algunas comparativas de rendimiento ([https://dev.to/mbarzeev/from-jest-to-vitest-migration-and-benchmark-23pl](https://dev.to/mbarzeev/from-jest-to-vitest-migration-and-benchmark-23pl)) podemos comprobar que Vitest es un poco más rápido en la ejecución inicial de los test pero muchísimo más rápido en el **modo watch**. Y es que, Vitest, una vez ejecutado, se queda esperando a que haya cambios en los test o en el desarrollo y **relanza** únicamente los **tests correspondientes a las partes del proyecto que vamos modificando**. Esto permite que podamos ser mucho más rápidos ejecutando y creando nuevos tests y que podamos dar a nuestro desarrollo un enfoque **TDD** (Test Driven Development).

Para confirmar que Vitest es la elección correcta investigamos un poco más sobre la **compatibilidad de Vite con Jest** y descubrimos que, si has creado tu app utilizando Vite, Jest puede dar muchos problemas, ya que **no está pensado al 100% para usarse con Vite**. ([https://stackoverflow.com/questions/71367514/vite-jest-react-testing](https://stackoverflow.com/questions/71367514/vite-jest-react-testing))
