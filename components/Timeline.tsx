  ...
  return (
    <ol className="border-s border-gray-400 my-8 px-0.5">
      <li className="mb-10 ms-4">
        <div className="w-3 h-3 bg-FMblue rounded-full mt-1.5 -ml-6 -start-1.5"></div>
        <time className="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">2021 - Hoy</time>
        <h3 className="text-xl font-semibold text-FMblue  dark:text-gray-100">Desarrollador Frontend</h3>
      ...
      <li className="mb-10 ms-4">
        ...
        <h3 className="text-xl font-semibold text-FMblue dark:text-white">Ingeniero de Software</h3>
      ...
      <li className="ms-4">
        ...
        <h3 className="text-xl font-semibold text-FMblue dark:text-white">Desarrollador de software embebido</h3>
